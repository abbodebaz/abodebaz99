...
const traits = [
  "أحوّل العمليات المعطّلة إلى أنظمة تشتغل وحدها",
  "أركّز على نتائج قابلة للقياس — لا مجرد تسليم",
  "أبني من الاستراتيجية حتى التنفيذ الفعلي",
  "خبرة في أكثر من 4 قطاعات مختلفة",
]
