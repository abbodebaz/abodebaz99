...
const caseStudies = [
  {
    ...
    problem: "الفريق كان ينفق على الإعلانات بدون ما يعرف أين الفلوس تروح. ما في تتبع دقيق، وكل شهر نفس المشكلة - الإنفاق أكثر والنتائج أقل.",
  ...
  },
  {
    ...
    problem: "الشركة تشتغل بطريقة يدوية - ورق، إكسيل، وناس تقضي وقتها في شغل ممل ممكن يتمتع. التوسع مستحيل وكل شي يأخذ وقت.",
